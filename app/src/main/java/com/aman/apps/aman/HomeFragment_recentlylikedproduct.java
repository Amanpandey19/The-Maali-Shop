...
public class HomeFragment_recentlylikedproduct extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        getActivity().setTitle("Liked by you");
        ...
        prreference= FirebaseDatabase.getInstance().getReference("Liked").child(username+phone);
