...
import com.aman.apps.aman.Fragments.SemiIndoorFragment;
...
public class HomeFragment_Semindoorproduct extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        prreference= FirebaseDatabase.getInstance().getReference("Semi-IndoorPlantProductPictures");
