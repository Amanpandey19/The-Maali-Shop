...
import com.aman.apps.aman.Fragments.Equipment_Fragment;
...
public class HomeFragment_Aeproduct extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
      ...
      Bundle b=getArguments();
        ...
        prreference= FirebaseDatabase.getInstance().getReference("AccessoriesAndEqiupmentsProductPictures");
                    ...
                    public void onDataChange(@NotNull DataSnapshot dataSnapshot) {
                        ...
                        if(!emailID.equals(""))
                        {
                            ...
                            if(arraylist.contains(e)) {
                                ...
                                final CartUpload uploadData=new CartUpload();
