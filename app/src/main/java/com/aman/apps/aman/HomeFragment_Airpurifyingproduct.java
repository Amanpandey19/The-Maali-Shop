...
import com.aman.apps.aman.Fragments.AirPurifyingPlantsFragment;
...
public class HomeFragment_Airpurifyingproduct extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        prreference= FirebaseDatabase.getInstance().getReference("AirpurifyingPlantProductPictures");
