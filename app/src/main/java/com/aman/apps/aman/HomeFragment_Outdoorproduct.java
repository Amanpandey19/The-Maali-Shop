...
import com.aman.apps.aman.Fragments.OutdoorFragment;
...
public class HomeFragment_Outdoorproduct extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        getActivity().setTitle("Outdoor plants");
        ...
        prreference= FirebaseDatabase.getInstance().getReference("OutdoorPlantProductPictures");
