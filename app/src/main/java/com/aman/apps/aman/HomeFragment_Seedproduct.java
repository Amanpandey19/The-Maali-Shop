...
import com.aman.apps.aman.Fragments.SeedFragment;
...
public class HomeFragment_Seedproduct extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        prreference= FirebaseDatabase.getInstance().getReference("SeedProductPictures");
