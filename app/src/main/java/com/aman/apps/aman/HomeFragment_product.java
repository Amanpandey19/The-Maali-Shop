...
import com.aman.apps.aman.Fragments.IndoorFragment;
...
public class HomeFragment_product extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        getActivity().setTitle("Indoor Plants");
        ...
        prreference= FirebaseDatabase.getInstance().getReference("IndoorPlantProductPictures");
