...
public class HomeFragment_recently_viewed_product extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootview = inflater.inflate(R.layout.product2, container, false);
        getActivity().setTitle("Recently Viewed");
       ...
       c8=rootview.findViewById(R.id.add_a_review);
        ...
        prreference= FirebaseDatabase.getInstance().getReference("Viewed").child(username+phone);
